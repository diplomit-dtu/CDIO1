...
public interface IFuncImpl {
	...
	void createUser(int userId ,String userName, String ini, List<String> roles, String cpr) throws DALException; //create userobjekt in funcImpl and ask for neccesary data
	void updateUser(int userId, String userName, String ini, String roles, String cpr, String password) throws DALException; // same concept
